...
plt.xlabel('Redshift')
plt.ylabel('lp')
plt.scatter(const_z,const_lp,s=40,alpha=1,marker='o',c='r',label='const')
...
plt.xlabel('Redshift')
plt.ylabel('lp')
plt.scatter(gauss_z,gauss_lp,s=40,alpha=1,marker='*',c='g',label='gauss')
plt.scatter(obs_z,obs_lp,s=30,alpha=1,marker='^',c='black',label='obs')
...
plt.xlabel('Redshift')
plt.ylabel('lp')
plt.scatter(bpl_z,bpl_lp,s=40,alpha=1,marker='o',c='blue',label='bpl')
plt.scatter(obs_z,obs_lp,s=30,alpha=1,marker='^',c='black',label='obs')
...
plt.xlabel('Redshift')
plt.ylabel('pea')
plt.scatter(const_z,const_pea,s=40,alpha=1,marker='o',c='r',label='const')
...
plt.xlabel('Redshift')
plt.ylabel('pea')
plt.scatter(gauss_z,gauss_pea,s=40,alpha=1,marker='*',c='g',label='gauss')
plt.scatter(obs_z,obs_pea,s=30,alpha=1,marker='^',c='black',label='obs')
plt.xlim(0,10)
...
plt.xlabel('Redshift')
plt.ylabel('pea')
plt.scatter(bpl_z,bpl_pea,s=40,alpha=1,marker='o',c='blue',label='bpl')
plt.scatter(obs_z,obs_pea,s=30,alpha=1,marker='^',c='black',label='obs')
plt.xlim(0,10)
...
plt.xlabel('Redshift')
plt.ylabel('eiso')
plt.scatter(const_z,const_eiso,s=40,alpha=1,marker='o',c='r',label='const')
...
plt.xlabel('Redshift')
plt.ylabel('eiso')
plt.scatter(gauss_z,gauss_eiso,s=40,alpha=1,marker='*',c='g',label='gauss')
plt.scatter(obs_z,obs_eiso,s=30,alpha=1,marker='^',c='black',label='obs')
plt.xlim(0,10)
...
plt.xlabel('Redshift')
plt.ylabel('eiso')
plt.scatter(bpl_z,bpl_eiso,s=40,alpha=1,marker='o',c='blue',label='bpl')
plt.scatter(obs_z,obs_eiso,s=30,alpha=1,marker='^',c='black',label='obs')
plt.xlim(0,10)
...
plt.xlabel('Redshift')
plt.ylabel('fluence')
plt.scatter(const_z,const_fluence,s=40,alpha=1,marker='o',c='r',label='const')
...
plt.xlabel('Redshift')
plt.ylabel('fluence')
plt.scatter(gauss_z,gauss_fluence,s=40,alpha=1,marker='*',c='g',label='gauss')
plt.scatter(obs_z,obs_fluence,s=30,alpha=1,marker='^',c='black',label='obs')
plt.xlim(0,10)
plt.ylim(-8,0)
...
plt.xlabel('Redshift')
plt.ylabel('fluence')
plt.scatter(bpl_z,bpl_fluence,s=40,alpha=1,marker='o',c='blue',label='bpl')
plt.scatter(obs_z,obs_fluence,s=30,alpha=1,marker='^',c='black',label='obs')
plt.xlim(0,10)
plt.ylim(-8,0)
