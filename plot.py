...
plt.ylim(0,0.8)
plt.legend(loc='best')
plt.savefig('result/plot/eiso_step.eps')
# plt.show()
...
plt.legend(loc='best')
plt.savefig('result/plot/t90_step.eps')
...
plt.legend(loc='best')
plt.savefig('result/plot/fluence_step.eps')
#plt.show()
...
plt.xlim(0,4)
plt.ylim(0,1)
plt.step(szobsindex_cdf,1-szobs_cdf,linewidth=5.3,linestyle='-',c='yellow',label='s_obs')
plt.step(zobsindex_cdf,1-zobs_cdf,linewidth=2.3,linestyle='-',c='black',label='obs')
plt.step(zindex,1-z_cdf_const,linewidth=1.9,linestyle='-.',c='r',label='const')
plt.step(zindexgauss,1-z_cdf_gauss,linewidth=1.9,linestyle='-.',c='g',label='gauss')
plt.step(zindexbpl,1-z_cdf_bpl,linewidth=1.9,linestyle='-.',c='b',label='bpl')
#plt.subplots_adjust(top = 1, bottom = 1, right = 1, left = 1, hspace = 1,wspace = 1)
#plt.margins(1,1)
plt.legend(loc='best')
plt.savefig('result/plot/z_cdf.eps')
...
plt.step(lpindex,lpconst,linewidth=1.1,linestyle='-',c='r',label='const')
plt.step(lpindexgauss,lpgauss,linewidth=1.1,linestyle='--',c='g',label='gauss')
plt.step(lpindexbpl,lpbpl,linewidth=1.1,linestyle='--',c='b',label='bpl')
plt.legend(loc='best')
plt.savefig('result/plot/lp_step.eps')
...
# plt.legend(loc='best')
# plt.savefig('result/plot/peak_flux_step.eps')
